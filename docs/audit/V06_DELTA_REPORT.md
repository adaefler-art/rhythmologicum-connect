...
> **This report is evidence-locked and fully reproducible.**
...
|-------|-------|--------|
| **Release** | v0.6 | — |
| **Baseline Tag** | v0.5.0 | `.audit/v06/evidence/baseline_sha.txt` |
| **Baseline Commit** | `6de6c86c826447ce2c93c19b74a08e8133f9deb0` | `.audit/v06/evidence/baseline_sha.txt` |
| **HEAD Commit** | `dd1d997a9186825d583078292a8e67f696ff9d84` | `.audit/v06/evidence/head_sha.txt` |
| **Report Generated** | 2026-01-16T22:00:00Z | — |
| **PRs in Scope** | 59 merged (since v0.5.0) | `.audit/v06/evidence/prs.json` |
| **PRs with File Evidence** | 12 | `.audit/v06/evidence/pr_files/*.json` |
...
- `.audit/v06/evidence/baseline_sha.txt` (v0.5.0 commit SHA)
- `.audit/v06/evidence/head_sha.txt` (HEAD commit SHA)
- `.audit/v06/evidence/prs.json` (59 merged PRs metadata)
- `.audit/v06/evidence/npm_scripts.json` (available npm scripts)
- `.audit/v06/evidence/pr_files/pr_<n>.json` (per-PR file lists for 12 high-risk PRs)
- `.audit/v06/delta-report.json` (machine-readable version of this report)

### Evidence Integrity

| File | Purpose | PR Count |
|------|---------|----------|
| `prs.json` | All merged PRs | 59 |
| `pr_610.json` | Seed data PR | 1 |
| `pr_611.json` | Dashboard-first policy | 1 |
| `pr_612.json` | Dashboard contract | 1 |
| `pr_613.json` | Pilot eligibility | 1 |
| `pr_614.json` | Dashboard components | 1 |
| `pr_618.json` | Navigation 404 fixes | 1 |
| `pr_621.json` | AMY Composer | 1 |
| `pr_623.json` | Triage pipeline | 1 |
| `pr_624.json` | Triage endpoint | 1 |
| `pr_626.json` | Triage sessions DB | 1 |
| `pr_627.json` | Red flag catalog | 1 |
| `pr_630.json` | Contract tests | 1 |
...
**Report Version:** 1.1.0 (evidence-locked)  
**Evidence Source:** `.audit/v06/evidence/`  
**Machine-Readable:** `.audit/v06/delta-report.json`  
**Test Matrix:** `docs/audit/V06_TEST_MATRIX.md`  
