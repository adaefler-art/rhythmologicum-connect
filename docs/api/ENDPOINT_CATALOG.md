...
| Path | Methods | Access | Intent | Used by | Internal unused | Route file |
| --- | --- | --- | --- | ---: | --- | --- |
...
| /api/amy/chat | GET, POST | system |  | 4 |  | apps/rhythm-patient-ui/app/api/amy/chat/route.ts |
...
| /api/clinician/anamnesis/[entryId]/versions | GET, POST | clinician |  | 1 |  | apps/rhythm-studio-ui/app/api/clinician/anamnesis/[entryId]/versions/route.ts |
...
| /api/clinician/consult-notes | GET, POST | clinician |  | 2 | yes - Issue 5 consult note APIs (no UI callsite yet) | apps/rhythm-studio-ui/app/api/clinician/consult-notes/route.ts |
| /api/clinician/consult-notes/[consultNoteId] | GET, PATCH | clinician |  | 2 | yes - Issue 5 consult note APIs (no UI callsite yet) | apps/rhythm-studio-ui/app/api/clinician/consult-notes/[consultNoteId]/route.ts |
| /api/clinician/consult-notes/[consultNoteId]/versions | GET | clinician |  | 1 | yes - Issue 5 consult note APIs (no UI callsite yet) | apps/rhythm-studio-ui/app/api/clinician/consult-notes/[consultNoteId]/versions/route.ts |
...
| /api/clinician/patient/[patientId]/amy-insights | GET | clinician |  | 2 |  | apps/rhythm-studio-ui/app/api/clinician/patient/[patientId]/amy-insights/route.ts |
| /api/clinician/patient/[patientId]/anamnesis | GET, POST | clinician |  | 3 |  | apps/rhythm-studio-ui/app/api/clinician/patient/[patientId]/anamnesis/route.ts |
| /api/clinician/patient/[patientId]/intake/latest | GET | clinician |  | 0 | yes - Clinician latest intake read model | apps/rhythm-studio-ui/app/api/clinician/patient/[patientId]/intake/latest/route.ts |
| /api/clinician/patient/[patientId]/intake/history | GET | clinician |  | 0 | yes - Clinician intake history | apps/rhythm-studio-ui/app/api/clinician/patient/[patientId]/intake/history/route.ts |
| /api/clinician/patient/[patientId]/intake/version/[versionNumber] | GET | clinician |  | 0 | yes - Clinician intake version lookup | apps/rhythm-studio-ui/app/api/clinician/patient/[patientId]/intake/version/[versionNumber]/route.ts |
| /api/clinician/patient/[patientId]/diagnosis/runs | GET | clinician |  | 2 |  | apps/rhythm-studio-ui/app/api/clinician/patient/[patientId]/diagnosis/runs/route.ts |
| /api/clinician/patient/[patientId]/results | GET | clinician |  | 2 |  | apps/rhythm-studio-ui/app/api/clinician/patient/[patientId]/results/route.ts |
...
| /api/clinician/triage/cases/[caseId]/ack | POST | clinician |  | 1 |  | apps/rhythm-studio-ui/app/api/clinician/triage/cases/[caseId]/ack/route.ts |
| /api/clinician/triage/cases/[caseId]/close | POST | clinician |  | 1 |  | apps/rhythm-studio-ui/app/api/clinician/triage/cases/[caseId]/close/route.ts |
| /api/clinician/triage/cases/[caseId]/flag | POST | clinician |  | 1 |  | apps/rhythm-studio-ui/app/api/clinician/triage/cases/[caseId]/flag/route.ts |
| /api/clinician/triage/cases/[caseId]/note | POST | clinician |  | 1 |  | apps/rhythm-studio-ui/app/api/clinician/triage/cases/[caseId]/note/route.ts |
| /api/clinician/triage/cases/[caseId]/reopen | POST | clinician |  | 1 |  | apps/rhythm-studio-ui/app/api/clinician/triage/cases/[caseId]/reopen/route.ts |
| /api/clinician/triage/cases/[caseId]/snooze | POST | clinician |  | 1 |  | apps/rhythm-studio-ui/app/api/clinician/triage/cases/[caseId]/snooze/route.ts |
...
| /api/patient/_meta/intake-write-check | GET | patient |  | 1 |  | apps/rhythm-patient-ui/app/api/patient/_meta/intake-write-check/route.ts |
| /api/patient/anamnesis | GET, POST | patient |  | 4 |  | apps/rhythm-patient-ui/app/api/patient/anamnesis/route.ts |
| /api/patient/anamnesis/[entryId] | GET, PATCH | patient |  | 4 |  | apps/rhythm-patient-ui/app/api/patient/anamnesis/[entryId]/route.ts |
...
| /api/patient/intake | POST | patient |  | 0 | deprecated - alias removed; use /api/clinical-intake/generate | apps/rhythm-patient-ui/app/api/patient/intake/route.ts |
| /api/patient/intake/latest | GET | patient |  | 0 | yes - Patient latest intake read model | apps/rhythm-patient-ui/app/api/patient/intake/latest/route.ts |
...
| /api/studio/diagnosis/run | GET | clinician |  | 1 |  | apps/rhythm-studio-ui/app/api/studio/diagnosis/run/route.ts |
