...
| /api/auth/callback | POST | public |  | 0 | apps/rhythm-legacy/app/api/auth/callback/route.ts |
...
| /api/auth/resolve-role | GET | public |  | 0 | apps/rhythm-legacy/app/api/auth/resolve-role/route.ts |
| /api/auth/resolve-role | GET | public |  | 4 | apps/rhythm-studio-ui/app/api/auth/resolve-role/route.ts |
| /api/auth/signout | GET, POST | public |  | 0 | apps/rhythm-legacy/app/api/auth/signout/route.ts |
