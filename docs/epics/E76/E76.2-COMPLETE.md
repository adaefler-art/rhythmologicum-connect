...
**Decision:** Create `createAdminSupabaseClient()` in the API route and pass it into the builder
...
- Keeps the builder server-only while complying with restricted-import rules
