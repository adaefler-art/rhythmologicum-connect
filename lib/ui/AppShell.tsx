        ...
        >
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              {subtitle && (
                <p className="text-sm md:text-base font-medium text-slate-900 mt-0.5">
                  {subtitle}
                </p>
              )}
            </div>
            <div className="flex items-center gap-3 md:gap-4">
              ...
              {onSignOut && (
                <button
                  onClick={onSignOut}
                  className="px-4 py-2.5 min-h-[44px] text-sm font-medium rounded-lg text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition-all duration-200 touch-manipulation"
                >
                  Abmelden
                </button>
              )}
