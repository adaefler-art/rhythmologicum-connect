...
export enum ErrorCode {
  ...
  ASSESSMENT_DEFINITION_NOT_FOUND = 'ASSESSMENT_DEFINITION_NOT_FOUND',
  ASSESSMENT_FK_VIOLATION = 'ASSESSMENT_FK_VIOLATION',
  ...
  SCHEMA_BLOCKED_BY_MIGRATIONS = 'SCHEMA_BLOCKED_BY_MIGRATIONS',
  SCHEMA_BUILD_TIMEOUT = 'SCHEMA_BUILD_TIMEOUT',
  SCHEMA_INTROSPECTION_FAILED = 'SCHEMA_INTROSPECTION_FAILED',
  SCHEMA_CACHE_CORRUPT = 'SCHEMA_CACHE_CORRUPT',
  SCHEMA_THRASHING = 'SCHEMA_THRASHING',
  SCHEMA_MIGRATION_CHECK_TIMEOUT = 'SCHEMA_MIGRATION_CHECK_TIMEOUT',
  SCHEMA_RPC_TIMEOUT = 'SCHEMA_RPC_TIMEOUT',
  SCHEMA_RPC_ERROR = 'SCHEMA_RPC_ERROR',
  SCHEMA_DB_CONNECT_FAILED = 'SCHEMA_DB_CONNECT_FAILED',
  SCHEMA_DB_QUERY_FAILED = 'SCHEMA_DB_QUERY_FAILED',
