	...
	public: {
		Tables: {
			...
			diagnosis_artifacts: {
				...
				Relationships: [
					{
						foreignKeyName: "diagnosis_artifacts_organization_id_fkey"
						columns: ["organization_id"]
						isOneToOne: false
						referencedRelation: "organizations"
						referencedColumns: ["id"]
			...
			diagnosis_run_artifacts: {
				...
				Relationships: [
					{
						foreignKeyName: "diagnosis_run_artifacts_artifact_id_fkey"
						columns: ["artifact_id"]
						isOneToOne: false
						referencedRelation: "diagnosis_artifacts"
						referencedColumns: ["id"]
					},
					{
						foreignKeyName: "diagnosis_run_artifacts_run_id_fkey"
						columns: ["run_id"]
						isOneToOne: false
			...
			diagnosis_runs: {
				...
				Relationships: [
					{
						foreignKeyName: "diagnosis_runs_clinician_user_id_fkey"
						columns: ["clinician_user_id"]
						isOneToOne: false
						referencedRelation: "pending_account_deletions"
						referencedColumns: ["user_id"]
					...
					{
						foreignKeyName: "diagnosis_runs_organization_id_fkey"
						columns: ["organization_id"]
						isOneToOne: false
						referencedRelation: "organizations"
						referencedColumns: ["id"]
