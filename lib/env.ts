...
function getRawClientEnv() {
  return {
    ...
    NEXT_PUBLIC_FEATURE_DIAGNOSIS_WORKER_ENABLED:
      process.env.NEXT_PUBLIC_FEATURE_DIAGNOSIS_WORKER_ENABLED,
...
export type Env = {
  ...
  NEXT_PUBLIC_FEATURE_DIAGNOSIS_WORKER_ENABLED?: string
