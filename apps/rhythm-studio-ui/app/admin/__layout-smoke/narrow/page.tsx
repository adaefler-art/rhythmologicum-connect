...
const navItems = [
  { label: 'Dashboard', href: '/admin/__layout-smoke/narrow?tab=dashboard' },
  { label: 'Funnels', href: '/admin/__layout-smoke/narrow?tab=funnels' },
  { label: 'Content', href: '/admin/__layout-smoke/narrow?tab=content' },
  { label: 'Navigation', href: '/admin/__layout-smoke/narrow?tab=navigation' },
  { label: 'Design System', href: '/admin/__layout-smoke/narrow?tab=design' },
]

function DummyContent() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-4">Layout Smoke Test (Narrow)</h1>
...
export default function LayoutSmokeNarrow() {
