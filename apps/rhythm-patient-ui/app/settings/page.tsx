      ...
      <div className="page-container dashboard-layout">
        ...
        {!loading && (
          <div className="settings-page">
            <section className="settings-card settings-card-wide space-y-4">
              <h2 className="text-lg font-semibold text-slate-900">Profil-Management</h2>
            ...
            <section className="settings-card space-y-3">
              ...
              <div className="rounded-md border border-slate-200 p-3 text-sm text-slate-600">
                Ihre Einstellungen werden sicher in Ihrem Profil gespeichert und beim Neuladen übernommen.
              </div>
            </section>
          </div>
        )}
