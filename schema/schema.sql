 ...
 WITH "latest_jobs" AS (
         ...
         SELECT "a_1"."id" AS "assessment_id",
            "array_remove"(ARRAY[
                    ...
                    WHEN ((EXISTS ( SELECT 1
                      ...
                      WHERE (("r"."assessment_id" = "a_1"."id") AND ("r"."risk_level" = 'high'::"text")))) OR (EXISTS ( SELECT 1
                       FROM ("public"."risk_bundles" "rb"
                         JOIN "latest_jobs" "lj_2" ON (("lj_2"."job_id" = "rb"."job_id")))
                      WHERE (("lj_2"."assessment_id" = "a_1"."id") AND (("rb"."bundle_data" ->> 'overall_risk_level'::"text") = 'critical'::"text")))) OR (EXISTS ( SELECT 1
                       FROM ("public"."safety_check_results" "scr"
                         JOIN "latest_jobs" "lj_2" ON (("lj_2"."job_id" = "scr"."job_id")))
                      WHERE (("lj_2"."assessment_id" = "a_1"."id") AND ("scr"."overall_action" = 'BLOCK'::"public"."safety_action"))))) THEN 'critical_flag'::"text"
                    ELSE NULL::"text"
                END,
                CASE
                    WHEN (("a_1"."status" = 'in_progress'::"public"."assessment_status") AND ("a_1"."started_at" < ("now"() - '7 days'::interval)) AND ("a_1"."completed_at" IS NULL)) THEN 'overdue'::"text"
                    ELSE NULL::"text"
                END,
                CASE
                ...
                CASE
                    WHEN ((EXISTS ( SELECT 1
                       FROM "latest_jobs" "lj_2"
                      WHERE (("lj_2"."assessment_id" = "a_1"."id") AND ("lj_2"."job_status" = 'failed'::"public"."processing_status") AND ("lj_2"."attempt" >= "lj_2"."max_attempts")))) OR (("a_1"."status" = 'in_progress'::"public"."assessment_status") AND ("a_1"."started_at" < ("now"() - '14 days'::interval)) AND ("a_1"."completed_at" IS NULL))) THEN 'stuck'::"text"
                    ELSE NULL::"text"
                END,
                CASE
                    WHEN (("a_1"."status" = 'completed'::"public"."assessment_status") AND ("a_1"."workup_status" = 'ready_for_review'::"public"."workup_status") AND (NOT (EXISTS ( SELECT 1
                       FROM "latest_reviews" "lr_1"
                      WHERE (("lr_1"."assessment_id" = "a_1"."id") AND ("lr_1"."review_status" <> 'PENDING'::"public"."review_status")))))) THEN 'review_ready'::"text"
                    ELSE NULL::"text"
                END,
                CASE
                    WHEN (EXISTS ( SELECT 1
                       FROM "latest_manual_flag" "lmf_1"
                      WHERE (("lmf_1"."assessment_id" = "a_1"."id") AND ("lmf_1"."action_type" = 'manual_flag'::"public"."triage_action_type")))) THEN 'manual_flag'::"text"
                    ELSE NULL::"text"
                END,
                CASE
                    WHEN (("a_1"."status" = 'in_progress'::"public"."assessment_status") AND ("a_1"."missing_data_fields" IS NOT NULL) AND ("jsonb_array_length"("a_1"."missing_data_fields") > 0)) THEN 'missing_data'::"text"
                    ELSE NULL::"text"
                END], NULL::"text") AS "attention_items_array"
           FROM ("public"."assessments" "a_1"
             LEFT JOIN "latest_jobs" "lj_1" ON (("lj_1"."assessment_id" = "a_1"."id")))
        )
 SELECT "a"."id" AS "case_id",
    ...
    COALESCE("pp"."preferred_name", "concat"("pp"."first_name", ' ', "pp"."last_name")) AS "patient_display",
        CASE
            ...
            WHEN (("a"."status" = 'completed'::"public"."assessment_status") AND (EXISTS ( SELECT 1
               FROM "latest_jobs" "lj_1"
              WHERE (("lj_1"."assessment_id" = "a"."id") AND ("lj_1"."job_status" = 'completed'::"public"."processing_status") AND ("lj_1"."job_stage" = 'report_generated'::"public"."processing_stage")))) AND (NOT (EXISTS ( SELECT 1
               FROM "latest_reviews" "lr_1"
              WHERE (("lr_1"."assessment_id" = "a"."id") AND ("lr_1"."review_status" = ANY (ARRAY['APPROVED'::"public"."review_status", 'REJECTED'::"public"."review_status"]))))))) THEN 'ready_for_review'::"text"
            ...
            WHEN (("a"."status" = 'in_progress'::"public"."assessment_status") AND ("a"."completed_at" IS NULL)) THEN 'in_progress'::"text"
    ...
    "ac"."attention_items_array" AS "attention_items",
        ...
        CASE
            WHEN (("a"."status" = 'completed'::"public"."assessment_status") AND ("a"."workup_status" = 'ready_for_review'::"public"."workup_status") AND ('critical_flag'::"text" = ANY ("ac"."attention_items_array"))) THEN 'clinician_review'::"text"
            WHEN (('stuck'::"text" = ANY ("ac"."attention_items_array")) AND (EXISTS ( SELECT 1
               FROM "latest_jobs" "lj_1"
              WHERE (("lj_1"."assessment_id" = "a"."id") AND ("lj_1"."job_status" = 'failed'::"public"."processing_status") AND ("lj_1"."attempt" >= "lj_1"."max_attempts"))))) THEN 'admin_investigate'::"text"
            ...
            WHEN (("a"."status" = 'in_progress'::"public"."assessment_status") AND ('stuck'::"text" = ANY ("ac"."attention_items_array"))) THEN 'clinician_contact'::"text"
            WHEN (EXISTS ( SELECT 1
               FROM "latest_jobs" "lj_1"
              WHERE (("lj_1"."assessment_id" = "a"."id") AND ("lj_1"."job_status" = 'failed'::"public"."processing_status") AND ("lj_1"."attempt" < "lj_1"."max_attempts")))) THEN 'system_retry'::"text"
            ...
            WHEN (("a"."status" = 'in_progress'::"public"."assessment_status") AND (NOT ('stuck'::"text" = ANY ("ac"."attention_items_array")))) THEN 'patient_continue'::"text"
            WHEN (("a"."status" = 'completed'::"public"."assessment_status") AND ((EXISTS ( SELECT 1
               FROM "latest_reviews" "lr_1"
              WHERE (("lr_1"."assessment_id" = "a"."id") AND ("lr_1"."review_status" = 'APPROVED'::"public"."review_status")))) OR (EXISTS ( SELECT 1
               FROM "latest_jobs" "lj_1"
              WHERE (("lj_1"."assessment_id" = "a"."id") AND ("lj_1"."delivery_status" = 'DELIVERED'::"text")))))) THEN 'none'::"text"
    ...
    "a"."completed_at",
        CASE
            ...
            WHEN (("a"."status" = 'completed'::"public"."assessment_status") AND ((EXISTS ( SELECT 1
              ...
              WHERE (("lr_1"."assessment_id" = "a"."id") AND ("lr_1"."review_status" = 'APPROVED'::"public"."review_status")))) OR (EXISTS ( SELECT 1
               FROM "latest_jobs" "lj_1"
              WHERE (("lj_1"."assessment_id" = "a"."id") AND ("lj_1"."delivery_status" = 'DELIVERED'::"text")))))) THEN false
            ELSE true
        END AS "is_active",
        CASE
            WHEN ("ls"."snoozed_until_str" IS NOT NULL) THEN ("ls"."snoozed_until_str")::timestamp with time zone
    ...
    ((((((
        CASE
            WHEN ('critical_flag'::"text" = ANY ("ac"."attention_items_array")) THEN 500
            WHEN (('overdue'::"text" = ANY ("ac"."attention_items_array")) OR ('stuck'::"text" = ANY ("ac"."attention_items_array"))) THEN 300
            WHEN ('manual_flag'::"text" = ANY ("ac"."attention_items_array")) THEN 250
            WHEN ("array_length"("ac"."attention_items_array", 1) > 0) THEN 100
            ELSE 0
        END +
        CASE
            WHEN (("a"."status" = 'completed'::"public"."assessment_status") AND ("a"."workup_status" = 'ready_for_review'::"public"."workup_status")) THEN 200
            WHEN (("a"."status" = 'in_progress'::"public"."assessment_status") AND ("a"."workup_status" = 'needs_more_data'::"public"."workup_status")) THEN 150
            WHEN ("a"."status" = 'in_progress'::"public"."assessment_status") THEN 50
            ELSE 0
        END) + LEAST((((EXTRACT(epoch FROM ("now"() - "a"."started_at")))::integer / 86400) * 2), 100)) +
        CASE
            WHEN ('critical_flag'::"text" = ANY ("ac"."attention_items_array")) THEN 200
            ELSE 0
        END) +
        CASE
            WHEN ('stuck'::"text" = ANY ("ac"."attention_items_array")) THEN 150
            ELSE 0
        END) +
        CASE
            WHEN ('overdue'::"text" = ANY ("ac"."attention_items_array")) THEN 100
            ELSE 0
        END) +
        CASE
            WHEN ('manual_flag'::"text" = ANY ("ac"."attention_items_array")) THEN 75
            ELSE 0
   ...
   FROM ((((((((("public"."assessments" "a"
     ...
     LEFT JOIN "public"."funnels_catalog" "f" ON (("f"."id" = "a"."funnel_id")))
  WHERE ("a"."status" = ANY (ARRAY['in_progress'::"public"."assessment_status", 'completed'::"public"."assessment_status"]));
