...
-- Indexes
CREATE INDEX idx_reassessment_rules_funnel ON public.reassessment_rules(funnel_id);
CREATE INDEX idx_reassessment_rules_active ON public.reassessment_rules(is_active);
CREATE INDEX idx_reassessment_rules_priority ON public.reassessment_rules(priority);
...
-- Indexes
CREATE INDEX idx_kpi_thresholds_key ON public.kpi_thresholds(kpi_key);
CREATE INDEX idx_kpi_thresholds_active ON public.kpi_thresholds(is_active);
CREATE INDEX idx_kpi_thresholds_metric_type ON public.kpi_thresholds(metric_type);
...
-- Indexes
CREATE INDEX idx_operational_audit_table ON public.operational_settings_audit(table_name);
CREATE INDEX idx_operational_audit_record ON public.operational_settings_audit(record_id);
CREATE INDEX idx_operational_audit_changed_by ON public.operational_settings_audit(changed_by);
CREATE INDEX idx_operational_audit_changed_at ON public.operational_settings_audit(changed_at DESC);
