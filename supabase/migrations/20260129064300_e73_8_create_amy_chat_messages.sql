...
ALTER TABLE public.amy_chat_messages
    DROP CONSTRAINT IF EXISTS amy_chat_messages_pkey;
...
ALTER TABLE public.amy_chat_messages
    DROP CONSTRAINT IF EXISTS amy_chat_messages_user_id_fkey;
...
CREATE INDEX IF NOT EXISTS amy_chat_messages_user_id_created_at_idx
...
DROP POLICY IF EXISTS amy_chat_messages_patient_select ON public.amy_chat_messages;
...
DROP POLICY IF EXISTS amy_chat_messages_patient_insert ON public.amy_chat_messages;
