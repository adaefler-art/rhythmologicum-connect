...
function guessAccessRoleFromApiPath(apiPath) {
  ...
  if (apiPath.startsWith('/api/account/')) return 'patient'
  ...
  if (apiPath.startsWith('/api/content/')) return 'patient'
  if (apiPath.startsWith('/api/documents/')) return 'system'
  if (apiPath.startsWith('/api/escalation/')) return 'patient'
  if (apiPath.startsWith('/api/funnels/')) return 'patient'
  if (apiPath.startsWith('/api/notifications')) return 'patient'
  if (apiPath.startsWith('/api/patient-measures/')) return 'patient'
  if (apiPath.startsWith('/api/patient-profiles')) return 'patient'
  if (apiPath.startsWith('/api/pre-screening-calls')) return 'clinician'
  if (apiPath.startsWith('/api/processing/')) return 'system'
  if (apiPath.startsWith('/api/reports/')) return 'clinician'
  if (apiPath.startsWith('/api/review/')) return 'clinician'
  if (apiPath.startsWith('/api/shipments')) return 'clinician'
  if (apiPath.startsWith('/api/support-cases')) return 'clinician'
  if (apiPath.startsWith('/api/tasks')) return 'clinician'
  if (apiPath.startsWith('/api/test/')) return 'system'
  return 'unknown'
}
